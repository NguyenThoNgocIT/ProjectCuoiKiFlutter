...
import 'package:e_commerce_doancuoikingocit/constants/utils.dart'; // Assuming you have this for pickImages
...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void selectImages() async {
    var res = await pickImages();  // Assuming pickImages is defined elsewhere
    setState(() {
      images = res;
    });
  }
