...
import 'package:e_commerce_doancuoikingocit/features/address/services/address_services.dart';
...
class _AddressScreenState extends State<AddressScreen> {
  ...
  void payPressed(String addressFromProvider) {
    ...
    if (isForm) {
      ...
      showSnackBar(context, 'ERROR: No address provided!');
      return;
    }
  }
            ...
            children: [
                    ...
                    CustomTextField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Please enter flat, house number, or building';
                        }
                        return null;
                      },
                    ),
              ...
              GooglePayButton(
                ...
                paymentConfigurationAsset:
                    'gpay.json', // Đường dẫn đến cấu hình Google Pay
